...
// Fork from https://github.com/influxdata/influxdb_iox/blob/123ba32fb9d8941f888d79f7608448e0cd722253/arrow_util/src/bitset.rs.
...
mod tests {
    ...
    fn test_arrow_compat() {
        ...
        assert_eq!(collected.as_slice(), buffer.sliced().as_slice());
        assert_eq!(
            buffer.sliced().as_slice(),

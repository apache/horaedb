...
mod tests {
    ...
    fn test_parquet_use_dictionary() {
        ...
        //         time_range: TimeRange::new_unchecked(Timestamp::new(1),
        // Timestamp::new(2)),         max_sequence: 200,
        //         schema: schema.clone(),
        //     };

        //     let mut counter = 5;
        //     let record_batch_stream = Box::new(stream::poll_fn(move |_| ->
        // Poll<Option<_>> {         if counter == 0 {
        ...
        //         ];
        //         let batch = build_record_batch_with_key(schema.clone(),
        // rows);         Poll::Ready(Some(Ok(batch)))
        //     }));
        ...
        //             .as_ref()
        //             .clone();
        //         // sst filter is built insider sst writer, so overwrite to
        // default for         // comparison.
        //         sst_meta_readback.parquet_filter = Default::default();
        //         assert_eq!(&sst_meta_readback,
        // &ParquetMetaData::from(sst_meta));         // assert_eq!(
        //         //     expected_num_rows,
        //         //     reader
        //         //         .row_groups()
        //         //         .await
        ...
        // 1000, 1_000_000));         expect_rows.push(build_row(b"b",
        // 100 + counter, 10.0, "v4", 1000, 1_000_000));

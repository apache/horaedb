...
mod tests {
    ...
    async fn test_row_merge_iterator() {
        ...
        let testcases = vec![
            // (sequence, rows)
            (10, vec![build_row(b"y", 1000000, 10.0, "v4",1000,1_000_000)]),
            (20, vec![build_row(b"y", 1000000, 10.0, "v3",1000,1_000_000)]),
            (100, vec![build_row(b"b", 1000000, 10.0, "v2",1000,1_000_000)]),
            (1, vec![build_row(b"a", 1000000, 10.0, "v1",1000,1_000_000)]),
        ];

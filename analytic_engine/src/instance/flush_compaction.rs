...
mod tests {
    ...
    fn test_split_record_batch_with_time_ranges() {
        let rows0 = vec![build_row(b"binary key", 20, 10.0, "string value",1000,1_000_000)];
        let rows1 = vec![build_row(b"binary key1", 120, 11.0, "string value 1",1000,1_000_000)];
        let rows2 = vec![
            build_row_opt(b"binary key2", 220, None, Some("string value 2"),Some(1000),None),

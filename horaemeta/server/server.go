...
import (
	...
	"github.com/LeslieKid/incubator-horaedb-meta/server/cluster"
	...
	"github.com/LeslieKid/incubator-horaedb-meta/server/limiter"
	"github.com/LeslieKid/incubator-horaedb-meta/server/member"
	metagrpc "github.com/LeslieKid/incubator-horaedb-meta/server/service/grpc"
	"github.com/LeslieKid/incubator-horaedb-meta/server/service/http"
	"github.com/LeslieKid/incubator-horaedb-meta/server/status"
...
func (srv *Server) startGrpcServer(_ context.Context) error {
	...
	server.RegisterService(&metaservicepb.MetaRpcService_ServiceDesc, grpcService)
